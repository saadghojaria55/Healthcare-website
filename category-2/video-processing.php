...
<body>
	...
	<div class="main">
		...
		<div class="container">
			...
			<ul class="breadcrumb">
				<li><a href="../product.php">Products</a></li>
				<li class="active">Video Processing</li>
...
Featuring resolution up to 4K plus a wide range of inputs and display modes, Sony's surgical monitors are compliant with the latest standards for clinical use. This equipment is intended for use by qualified medical professionals only. Registration status as a medical device may vary, depending on country.</p>
				...
				<section class="product_listing">
					...
					<div class="row" align="right">
						...
						<?php    
				$sql = mysqli_query($conn, "SELECT img_src,caption,tag FROM products WHERE cat_tag='cat_2'");
