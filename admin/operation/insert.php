...
Dashboard</i></li>
	...
	Add New Content</h2></div>
			<form id="insert_form" method="POST" >
				...
				<table>
					<tr>
				<td><textarea class="tarea" rows="10" cols="65" name="content" id="content" placeholder="Enter Your Content Here"></textarea></td>
			</tr>
		...
		<a href="../aboutus.php" >View Data</a>
		<div id="display"></div>
</body>
