...
<head>
	...
	<title>Surgical Imaging Monitors
...
<body>
	...
	<div class="main">
		...
		<div class="container">
			...
			<ul class="breadcrumb">
				<li><a href="../product.php">Products</a></li>
				<li class="active">Surgical Imaging Monitors</li>
			...
			<section class="product_des_section">
				...
				<h1>Surgical Imaging Monitors</h1>

				<p>Featuring resolution up to 4K plus a wide range of inputs and display modes, Sony's surgical monitors are compliant with the latest standards for clinical use.
				...
				<section class="product_listing">
					...
					<div class="row" align="right">
						...
						<?php    
				$sql = mysqli_query($conn, "SELECT img_src,caption,tag FROM products WHERE cat_tag='cat_1'");
