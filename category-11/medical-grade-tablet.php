...
<body>
	...
	<div class="main">
		...
		<div class="container">
			...
			<ul class="breadcrumb">
				<li><a href="../product.php">Products</a></li>
				<li class="active">Medical Grade Tablet</li>
			...
			<section class="product_des_section">
				...
				<section class="product_listing">
					...
					<div class="row" align="right">
						...
						<?php    
				$sql = mysqli_query($conn, "SELECT img_src,caption,tag FROM products WHERE cat_tag='cat_11'");
